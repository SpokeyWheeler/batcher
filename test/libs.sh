...
myruntests() {
	...
	./batcher update -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -table serialtest -set "strcol='b'" -user btest -where "strcol='a'" -execute

	sera=$( $SQLCMD "SET CHARACTER SET 'utf8'; SET NAMES 'utf8' COLLATE 'utf8_general_ci'; SELECT COUNT(*) FROM serialtest WHERE strcol = 'a';" 2> /dev/null | grep -iv count | grep -iv row )
	comp "Updated serial a" "$expa" "$sera"

	./batcher delete -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -table serialtest -user btest -where "intcol<101" -execute

	sertot=$( $SQLCMD "SET CHARACTER SET 'utf8'; SET NAMES 'utf8' COLLATE 'utf8_general_ci'; SELECT COUNT(*) FROM serialtest;" 2> /dev/null | grep -iv count | grep -iv row )
	comp "Small delete serial total" "$exptot" "$sertot"

	./batcher update -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -set "strcol='b'"  -table compositetest -user btest -where "strcol='a'" -execute
	...
	./batcher delete -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -table compositetest -user btest -where "intcol<101" -execute
	...
	./batcher delete -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -table serialtest -user btest -where "1=1" -execute

	sertot=$( $SQLCMD "SET CHARACTER SET 'utf8'; SET NAMES 'utf8' COLLATE 'utf8_general_ci'; SELECT COUNT(*) FROM serialtest;" 2> /dev/null | grep -iv count | grep -iv row )
	comp "Full delete serial total" "$exptot" "$sertot"

	./batcher delete -concurrency 4 -database batchertestdb -dbtype mysql -host mysql -opts $opts -password btest -portnum $portnum -table compositetest -user btest -where "1=1" -execute

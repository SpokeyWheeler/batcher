...
echo "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci';
...
sertot=$( $SQLCMD "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci'; SELECT COUNT(*) FROM serialtest;" ) # 2> /dev/null | grep -iv count | grep -iv row )
comp "Initial serial total" $exptot $sertot
sera=$( $SQLCMD "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci'; SELECT COUNT(*) FROM serialtest WHERE strcol = 'a';" 2> /dev/null | grep -iv count | grep -iv row )
comp "Initial serial a" $expa $sera
cmptot=$( $SQLCMD "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci'; SELECT COUNT(*) FROM compositetest;" 2> /dev/null | grep -iv count | grep -iv row )
comp "Initial composite total" $exptot $cmptot
cmpa=$( $SQLCMD "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci'; SELECT COUNT(*) FROM compositetest WHERE strcol = 'a' COLLATE 'utf8_unicode_ci';" 2> /dev/null | grep -iv count | grep -iv row )
...
cmpa=$( $SQLCMD "SET NAMES 'utf8mb4' COLLATE 'utf8_unicode_ci'; SELECT COUNT(*) FROM compositetest WHERE strcol = 'a';" 2> /dev/null | grep -iv count | grep -iv row )

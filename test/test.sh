...
psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" < /tmp/$$
...
sertot=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM serialtest;" )
comp "Initial serial total" $exptot $sertot
sera=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM serialtest WHERE strcol = 'a';" )
comp "Initial serial a" $expa $sera
uidtot=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM uuidtest;" )
comp "Initial UUID total" $exptot $uidtot
uida=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM uuidtest WHERE strcol = 'a';" )
comp "Initial UUID a" $expa $uida
cmptot=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM compositetest;" )
comp "Initial composite total" $exptot $cmptot
cmpa=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432" -t -A -c "USE batchertestdb; SELECT COUNT(1) FROM compositetest WHERE strcol = 'a';" )
...
cmptot=$( psql -q -u $POSTGRES_USER "postgresql://root@localhost:5432"USE batchertestdb; SELECT COUNT(1) FROM compositetest;" )
